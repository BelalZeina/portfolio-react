    ...
    >
      <Container maxWidth="lg">
        <Helmet>
          ...
          <meta
            name="description"
            content="Learn about Belal Zeina's web development skills."
          />
        </Helmet>
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              ...
              >
                Hello, I'm Belal Zeina — a dedicated Full Stack Web Developer
                with a strong passion for continuous learning and professional
                excellence.
              </Typography>
              ...
              <Typography
                ...
                sx={{ mb: 3, fontSize: "1.1rem", lineHeight: 1.8 }}
              >
                I bring extensive experience in both front-end and back-end
                development, with a particular focus on building responsive,
                user-centric interfaces and robust server-side solutions.
              </Typography>
              ...
              <Typography
                ...
                sx={{ mb: 3, fontSize: "1.1rem", lineHeight: 1.8 }}
              >
                I specialize in developing modern front-end experiences, and I'm
                highly proficient in Laravel for back-end development, including
                building secure and scalable APIs. I thrive in collaborative
                environments, use GitHub for version control, and am always
              ...
              >
                Take a look at my projects to see the quality and versatility of
                my work.
              </Typography>
                    ...
                    >
                      ...
                      >
                        ...
                        <Chip
                          ...
                          sx={{
                            background:
                              tool.level === "Advanced" ? "#e0f7fa" : "#fffde7",
                            color:
                              tool.level === "Advanced" ? "#00796b" : "#fbc02d",
                            fontWeight: 700,
                          }}
                        />
                      </Card>
